  ...
  return (
    <section className="panel base">
      ...
      <div className='flex flex-col lg:flex-row lg:max-w-[1024px] gap-10 px-20 mx-auto lg:items-stretch'>
        <div className='flex flex-col gap-4 items-center justify-start tracking-[-0.7] leading-[1.25] font-cormorant text-[42px] lg:flex-1'>
        ...
        <div className='flex flex-col  gap-4 lg:max-w-[1024px]  px-20  items-center justify-start tracking-[-0.7] leading-[1.25] font-cormorant text-[48px] lg:flex-1'>
          ...
          <a className='text-primary text-[32px] text-white bg-[#434430] rounded-xl mt-6 px-10 py-1 text-[#EEEDED]' href='https://maps.app.goo.gl/7jWkmceP8epDoVCa9' target='_blank' rel='noreferrer'>UBICACIÓN</a>
        </div>
      </div>
